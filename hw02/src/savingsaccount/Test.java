...
public class Test {
	public static void main(String[] args) {
		...
		TestRunner.runTest(()->{
			...
			if (String.format("%.3f",balance0).equals("1.659")) System.out.println("Accept");
		...
		TestRunner.runTest(()->{
			...
			if (ans.equals("16.591 16.605 24.886 24.907")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (ans.equals("297.957")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (ans.equals("497.723 991.771 832.397")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
