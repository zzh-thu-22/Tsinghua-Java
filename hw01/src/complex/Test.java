...
public class Test {
	public static void main(String[] args) {
		...
		TestRunner.runTest(()->{
			...
			if (x.toString().equals("0.000")) System.out.println("Accept");
		...
		Complex c = new Complex(1, 1);
			...
			if (c.toString().equals("1.000+1.000i")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (c.toString().equals("-1.000-2.000i")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (c.toString().equals("1.500i")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (c.toString().equals("-1.000+3.500i")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (c.toString().equals("196.330")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (c.toString().equals("-306.000i")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (c.toString().equals("-0.273-0.365i")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
