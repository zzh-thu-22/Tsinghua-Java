...
public class Test {
	public static void main(String[] args) {
		...
		TestRunner.runTest(()->{
			...
			if (r.numerator == 1 && r.denominator == 2 && r.toString().equals("1/2")) System.out.println("Accept");
		...
		TestRunner.runTest(()->{
			...
			if (r.numerator == 7 && r.denominator == 6) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (r.numerator == 5 && r.denominator == 12) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (r.numerator == 5 && r.denominator == 14) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (r.numerator == 3 && r.denominator == 2) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (r.toDouble()==1.5) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			if (r.toString().equals("2")) System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
